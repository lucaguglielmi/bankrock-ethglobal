...
| [20-privy-earn-and-hackathon-qualification.md](./20-privy-earn-and-hackathon-qualification.md) | The Privy prize requirements assessed one by one, and the Earn integration that closes the gap: *Savings* on Base mainnet from the embedded wallet, user-signed writes, the realised-yield rule, the operator checklist and the demo beat | Active |
