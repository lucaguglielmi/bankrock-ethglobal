...
<svg viewBox="0 0 160 160" className="w-full h-full z-10 opacity-90 transition-transform duration-1000 group-hover:scale-105" style={{ filter: 'drop-shadow(0 20px 30px rgba(0,0,0,0.05))' }}>
  <g transform="translate(-4.723747308838341, -2.5) scale(0.01710225290420686, -0.01710225290420686) translate(-1043.07, -10238.65)">
  ...
  <g transform="translate(45.63, 20.18)">
  ...
  <g transform="translate(82.25, 20.53)">
    <circle cx="0" cy="0" r="1" className="fill-neutral-300" />
  ...
  <g transform="translate(69.83, 45.74)">
  ...
  <g transform="translate(84.37, 73.91)">
    <circle cx="0" cy="0" r="1" className="fill-neutral-300" />
